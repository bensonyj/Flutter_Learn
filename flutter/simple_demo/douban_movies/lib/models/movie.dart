...
class Movie {
  ...
  bool hasLiked = false;
  List<Actor> actors;
  List<Review> reviews = [Review(), Review(), Review(), Review()];
  List<Comment> comments = [Comment(), Comment(), Comment(), Comment()];
  ...
  Movie.fromJSON(Map<String, dynamic> json) {
    ...
    this.actors = (json['casts'] as List).map((item) {
      ...
      if (item != null && item['avatars'] != null && item['avatars'].length > 0) {
