  ...
  showPopup(BuildContext context, MovieItemBloc bloc, Movie movie) {
    if (Platform.isIOS) {
      showCupertinoModalPopup(
        context: context,
        builder: (_context) {
          final linkeAction = CupertinoActionSheetAction(
            onPressed: () {
...
class MovieItemBig extends StatelessWidget with MovieFavPopupMixin {
  ...
  Widget build(BuildContext context) {
    final bloc = BlockProvider.of<MovieItemBloc>(context);
                        ...
                        children: <Widget>[
                          Row(
                            children: <Widget>[
                              ...
                              GestureDetector(
                                onTap: () => showPopup(context, bloc, movie),
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                ...
                                Text(movie.actors.map((actor) => actor.name).join('/'),
                                overflow: TextOverflow.ellipsis, style: TextStyle(fontSize: 14, color: Colors.white70),)
                              ],
                            ),
                          ),
                        ),
